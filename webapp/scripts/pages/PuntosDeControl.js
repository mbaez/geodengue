    ...
    return Backbone.Page.extend({
        ...
        initSelectPopup : function(feature) {
            var popup = new PopupView({
                ...
                fields : [
                 { label : "Id Muestra", id:"id_muestras", placeholder:"Ingrese el id de muestra"},
                 { label : "Cantidad", id:"cantidad", placeholder:"Ingrese la cantidad"},
                 { label : "Fecha", id:"fecha_recoleccion", placeholder:"" , type : "date"}
                ]
            });
            return popup;
        },
        ...
        initAddPopup : function(feature){
            var popup = new PopupView({
                ...
                fields : [
                 ...
                 { label : "Id Muestra", id:"id_muestras", placeholder:"Ingrese el id de muestra"},
                 { label : "Descripcion", id:"descripcion", placeholder:"Ingrese la descripcion"},
